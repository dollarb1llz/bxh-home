<?php include 'res/inc/header.php'; ?>

  <!--Supporting-->

  <div class="color-box purple before">
    <div class="banner surfer-babe">
...
<img class="left" src="./res/img/sun-dude-guitar.jpg" />
      <p>
        ...
        <span>Drink as much water and tea as you can.</span>
        <span>And then make sure to read, watch and strum the guitar.</span>
      </p>
      <p>
      ...
      <p>
        <span>Getting to work on time is another great way to feel good.</span>
        <span>When we get there on time, we work harder and everything seems so more legit</span>
        <span>Then you just have to make sure you make circles and code in that order.</span>
        <span>If we can get to Giant Eagle and grab some lettuce for dinner yeah.</span>
      </p>
      ...
      <p>
        ...
        <span>I want to keep an eye on my posture, keeping my core engaged whenever possible.</span>
        <span>Also try to BE as relaxed as possible all day, like slow movements and relaxed tone.</span>
        <span>The other thing I want to make sure I do is to just shut up and smile.</span>
          <span>brk</span>
        <span>I also want to make sure I document these things that give me joy.</span>
        <span>So that way I can use that footage on my daily video summary.</span>
        <span>I can also use this footage for my checklist pages to show my progress in those areas.</span>
        <span>Which would be dope man.</span>

      </p>
      <p>
        <span>To end the day is as important as the begining of the day.</span>
        <span>Work on your Skating, Basketball and Fitness and Spirituality.</span>
        <span>Update yourself on what you've accomplished and plan for the next day with BxH.</span>
        <span>A brisk walk comboed with a bath and deep breathing makes for a good sleep.</span>
      </p>
    </div>
  </div>
